---
title: Finding the features nobody used
slug: carfax-analytics
role: Data Product Analyst
org: Carfax
timeframe: Sept 2025 – Apr 2026
teamSize: Cross-functional (product, eng, leadership)
whatThisShows: Moving from measuring the product to deciding it
cardProblem: Feature-level usage was invisible, so roadmap arguments were won by whoever argued hardest.
tags: ["Product Analytics", "Prioritization", "ETL"]
order: 3
confidential: true
