---
title: Shipping an agentic AI product when you can't trust the output
...
cardProblem: Non-deterministic output breaks the normal PM feedback loop — you can't tell whether a change improved things or quietly regressed them.
